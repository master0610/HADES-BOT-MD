...
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '𝚃𝙷𝙴 𝙷𝙰𝙳𝙴𝚂 𝙱𝙾𝚃', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/Yovanihades1212/HADES-BOT-MD.git' }, mentionedJid: [m.sender] }}}, { quoted: m })
